...
namespace PINQ
{
    ...
    public class PINQueryable<T> : IEnumerable<T>
    {
        /// <summary>
        ...
        private double Laplace(double stddev)//stddev标准差
        {
        ...
        public double NoisyCount(double epsilon)
        {
            ...
            // Commence the agent process.开始代理流程
        ...
        #region Projection Transformations投影变换
